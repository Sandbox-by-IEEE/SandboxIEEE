  ...
  return (
    <GradientBox type='default' className="relative lg:h-[697px] lg:w-[1191px] w-[336px] h-[316px] rounded-[64px] lg:rounded-[128px] overflow-hidden">
      <div className="absolute inset-0 flex -z-10">
        <Image src="/1.svg" width={4096} height={4096}
          className={`absolute w-[299px] h-[299px] lg:w-[806px] lg:h-[806px] object-cover left-[120px] top-[-186px] lg:top-[-498px] lg:left-[678px]`} alt="img1" />
        <Image src="/4.svg" width={4095} height={4096}
          className={`absolute w-[396px] h-[521px] object-cover left-[-185px] top-[-120px]  lg:w-[983px] lg:h-[1294px]  lg:left-[-500px] lg:top-[-400px]`} alt="img2" />
