...
export default function GrandSeminar() {
  return (
    <div className=' min-h-screen h-fit w-full min-w-[600px] block bg-[#081E11]'>
      {/* replace with navbar */}
      ...
      <section className='Section w-full h-fit pl-[100px] pr-[100px] bg-gradient-to-b from-[rgba(7,29,16,0.45)] to-[#0F3015] bg-cover block '>
        <div className='min-h-[720px] h-fit w-full block pb-28'>
          <Image
        ...
        <div className=' min-h-[720px] h-fit w-full block pb-40'>
