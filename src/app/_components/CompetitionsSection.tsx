          ...
          {competitions.map((competition) => (
            ...
            >
              ...
              <div className="space-y-2 mb-4 md:mb-6 text-white/70 font-gemunu text-xs sm:text-sm">
                <p>Team size: {competition.minTeamSize === competition.maxTeamSize
                  ? competition.minTeamSize
                  : `${competition.minTeamSize}-${competition.maxTeamSize}`} members</p>
                <p>Fee: {new Intl.NumberFormat('id-ID', {
                  style: 'currency',
                  currency: 'IDR',
                  minimumFractionDigits: 0,
                }).format(competition.registrationFee)}</p>
              </div>
