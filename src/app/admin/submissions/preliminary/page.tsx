...
export const metadata = {
  title: 'Preliminary Submissions | Admin Panel',
  description: 'Manage preliminary submissions from teams',
};
...
export default async function PreliminarySubmissionsPage() {
  ...
  // Fetch all preliminary submissions with team and competition data
  const submissions = await prisma.preliminarySubmission.findMany({
    include: {
      registration: {
        include: {
          team: {
